...
public class AdaperBaoxiao extends BaseAdapter
{
	private List<FinishPeddingItem> listItems =new ArrayList<FinishPeddingItem>();
	private LayoutInflater inflater;

	public AdaperBaoxiao(Context context, List<FinishPeddingItem> list)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null)
		{
			convertView=inflater.inflate(R.layout.homelist_item2, parent, false);
