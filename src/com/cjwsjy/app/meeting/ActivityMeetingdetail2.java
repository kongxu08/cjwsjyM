...
public class ActivityMeetingdetail2 extends BaseActivity implements OnScrollListener, OnItemClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.meeting_detail2);
	...
	public ListView initList()
	{
		...
		listItemAdapter = new FinishPeddingListAdaper(ActivityMeetingdetail2.this, listItems);
		// 添加并且显示
