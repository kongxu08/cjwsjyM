...
public class ActivityMeetingdetail1 extends BaseActivity implements OnScrollListener, OnItemClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.meeting_detail1);
...
//		TextView tv_view = (TextView) this.findViewById(R.id.textView23);
//		tv_view.setText("您已签到");
//		
//		Button bt_qiandao = (Button) this.findViewById(R.id.imageButton1);
//		bt_qiandao.setVisibility(View.GONE);
		
		//会议信息
		TextView tv_info = (TextView) findViewById(R.id.textView24);
		tv_info.setOnClickListener(new OnClickListener()
		{
			@Override
			public void onClick(View v)
			{
				Intent intent = new Intent( ActivityMeetingdetail1.this, ActivityMeetingdetail2.class);
				startActivity(intent);
			}
		});
		
		//我的座位
		TextView tv_seat = (TextView) findViewById(R.id.textView25);
		tv_seat.setOnClickListener(new OnClickListener()
		{
			@Override
			public void onClick(View v)
			{
		...
		//会议投票
		TextView tv_vote = (TextView) findViewById(R.id.textView26);
		tv_vote.setOnClickListener(new OnClickListener()
		{
			@Override
			public void onClick(View v)
			{
				Intent intent = new Intent( ActivityMeetingdetail1.this, ActivityMeetingVoteItem.class);
				startActivity(intent);
			}
		});
		//initList();
	...
	public ListView initList()
	{
		...
		listItemAdapter = new FinishPeddingListAdaper(ActivityMeetingdetail1.this, listItems);
		// 添加并且显示
	...
	public boolean onCreateOptionsMenu(Menu menu)
	{
		...
		public void onScrollStateChanged(AbsListView view, int scrollState) 
	    {
			...
			if( scrollState == OnScrollListener.SCROLL_STATE_IDLE && lastVisibleIndex == listItemAdapter.getCount()) 
			{
