 ...
 */
public class WebViewBQ extends BaseActivity {
...
//				.setAutoCancel(true);                           //设置点击后取消Notification
	...
	{
		WebView webView = new WebView(WebViewBQ.this);
	...
	private void showProgressDialog(String msg, boolean cancelable) 
	{
		if (mDialog == null && mWebView != null) {
			mDialog = new ProgressDialog(WebViewBQ.this);
	...
	protected int DownAttachment(String url)
	{
		...
		android.util.Log.d("cjwsjy", "------下载附件-------");
		...
		android.util.Log.d("cjwsjy", "---------下载附件"+attachmentName+"-------");
	...
	protected int PreviewAttachment(String url)
	{
		...
		if(!file.exists())
		{
			//如果文件不存在，
			//开线程,下载文件
            Toast.makeText(WebViewBQ.this, "正在缓存文件！", Toast.LENGTH_SHORT).show();
			m_downmode = 2;
			startThreadDown();
		}
		else
		{
			...
			openfile.openFile(WebViewBQ.this, file2);
		}
		return 1;
	}
	...
	protected int DeleteAttachment(String url)
	{
		...
		android.util.Log.d("cjwsjy", "---------删除附件="+attachmentName+"-------");
		...
		if(file.exists())
		{
			...
			Toast.makeText(WebViewBQ.this, "删除文件成功！", Toast.LENGTH_SHORT).show();
		...
		{
			Toast.makeText(WebViewBQ.this, "删除文件失败！文件未找到", Toast.LENGTH_SHORT).show();
		}
	...
	private void startThreadDown()
	{
		new Thread()
		{
			public void run()
			{
				...
				android.util.Log.d("cjwsjy", "------name="+fileUrl+"-------downurl");
	...
	Handler handler = new Handler()
	{
		public void handleMessage(android.os.Message msg)
		{
			switch (msg.what)
			{
				case 1:
					// 下载成功
					Toast.makeText(WebViewBQ.this, "下载成功！", Toast.LENGTH_SHORT).show();
				...
				case 2:
					...
					break;
				case 10:
					Toast.makeText(WebViewBQ.this, "下载失败！", Toast.LENGTH_SHORT).show();
					CallJavaScript("failed");
					break;
				case 11:
					//预览，下载失败
					Toast.makeText(WebViewBQ.this, "获取文件失败！", Toast.LENGTH_SHORT).show();
					break;
				default:
					break;
			}
	...
	protected void CallJavaScript(String filename)
	{
		...
		android.util.Log.d("cjwsjy", "------DOWNFromPhone-------");
	...
	protected void CallJavaScript2(String filename)
	{
		...
		android.util.Log.d("cjwsjy", "------Deletename="+filename+"-------DeleteFromPhone");
