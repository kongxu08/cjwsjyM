package com.cjwsjy.app.pedometerservice;
...
import com.cjwsjy.app.pedometer.Constant;
...
public class StepService extends Service implements SensorEventListener {
        ...
        public void handleMessage(Message msg)
        {
            switch (msg.what)
            {
                case Constant.MSG_FROM_CLIENT:
                    ...
                    break;
                case Constant.MSG_FROM_CLIENT1:
                    //StepDcretor.CURRENT_SETP = 0;
                    try
                    {
                        Messenger messenger = msg.replyTo;
                        Message replyMsg = Message.obtain(null, Constant.MSG_FROM_SERVER2);
                        Bundle bundle = new Bundle();
                        bundle.putInt("sensor", mSensor);
                        replyMsg.setData(bundle);
                        messenger.send(replyMsg);
                    }
                    catch (RemoteException e)
    ...
    public void onCreate()
    {
        ...
        android.util.Log.d("cjwsjy", "------onCreate-------StepService");
    ...
    private void updateNotification(String content)
    {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0, new Intent(this, ActivityPedometer2.class), 0);
    ...
    private void initSensor()
    {
        ...
        //addBasePedoListener();
        //给activety发消息，告诉是否有计步传感器
        try
        {
            //Messenger messenger = msg.replyTo;
            Message replyMsg = Message.obtain(null, Constant.MSG_FROM_SERVER2);
            Bundle bundle = new Bundle();
            bundle.putInt("sensor", nresult);
            replyMsg.setData(bundle);
            messenger.send(replyMsg);
        }
        catch (RemoteException e)
    ...
    private int addCountStepListener()
    {
    ...
    {
        android.util.Log.d("cjwsjy", "------onDestroy-------StepService");
