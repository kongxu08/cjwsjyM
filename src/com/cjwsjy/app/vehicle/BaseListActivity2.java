 ...
 */
abstract public class BaseListActivity2 extends BaseActivity2 implements ItemViewHandler{
	...
	public void doSearch2(String parm)
    {
        if(isRequest)
        {
            return;
		...
		String strurl = UrlManager.appRemoteUrl+"Services/GetOrderList.aspx";
