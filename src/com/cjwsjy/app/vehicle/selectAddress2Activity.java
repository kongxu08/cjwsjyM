 ...
 * 
 */
public class selectAddress2Activity extends BaseActivity2 implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setHeadView(R.drawable.onclick_back_btn, "", "目的地", 0, "", this, this, this);
		init();
		getAddress();
	   }
	  ...
	  @Override
		...
		switch (v.getId()) {
		case R.id.leftImage:
			if (selectAddress2Activity.this.getCurrentFocus() != null)
			{
				InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
				imm.hideSoftInputFromWindow(selectAddress2Activity.this.getCurrentFocus().getWindowToken(),
